	...
	try:
		if temp_plot:
			...
			if not data0.empty:
				...
				plt.text(data0.index[-1:][0], data0['Temperature'][-1], data0['Temperature'][-1], fontsize=12, color=plt.rcParams['axes.color_cycle'][0])
			...
			if not data1.empty:
				...
				plt.text(data1.index[-1:][0], data1['Temperature'][-1], data1['Temperature'][-1], fontsize=12, color=plt.rcParams['axes.color_cycle'][1])
			...
			if not data2.empty:
				...
				plt.text(data2.index[-1:][0], data2['Temperature'][-1], data2['Temperature'][-1], fontsize=12, color=plt.rcParams['axes.color_cycle'][2])
			...
			if not data3.empty:
				...
				plt.text(data3.index[-1:][0], data3['Temperature'][-1], data3['Temperature'][-1], fontsize=12, color=plt.rcParams['axes.color_cycle'][3])
			...
			if not data4.empty:
				...
				plt.text(data4.index[-1:][0], data4['Temperature'][-1], data4['Temperature'][-1], fontsize=12, color=plt.rcParams['axes.color_cycle'][4])
			...
			if not data5.empty:
				...
				plt.text(data5.index[-1:][0], data5['Temperature'][-1], data5['Temperature'][-1], fontsize=12, color=plt.rcParams['axes.color_cycle'][5])
			...
			plt.legend(bbox_to_anchor=(0., 1.02, 1., .102), loc=3, ncol=2, mode="expand", borderaxespad=0.).set_visible(True)
