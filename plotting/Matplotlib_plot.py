...
if (1):
	...
	try:
		if temp_plot:
			...
			plt.text(data2.index[-1:][0], data2['Temperature'][-1], sensor2label, fontsize=12, color=plt.rcParams['axes.color_cycle'][4])
			...
			plt.text(data3.index[-1:][0], data3['Temperature'][-1], sensor3label, fontsize=12, color=plt.rcParams['axes.color_cycle'][3])
			plt.plot_date(data4.last(td).index, data4['Temperature'].last(td).values, linestyle="solid", linewidth=line_width, marker='None', color=plt.rcParams['axes.color_cycle'][2], label=sensor4label)
			plt.text(data4.index[-1:][0], data4['Temperature'][-1], sensor4label, fontsize=12, color=plt.rcParams['axes.color_cycle'][2])
			plt.plot_date(data5.last(td).index, data5['Temperature'].last(td).values, linestyle="solid", linewidth=line_width, marker='None', color=plt.rcParams['axes.color_cycle'][1], label=sensor5label)
			plt.text(data5.index[-1:][0], data5['Temperature'][-1], sensor5label, fontsize=12, color=plt.rcParams['axes.color_cycle'][1])
			plt.plot_date(data6.last(td).index, data6['Temperature'].last(td).values, linestyle="solid", linewidth=line_width, marker='None', color=plt.rcParams['axes.color_cycle'][0], label=sensor6label)
			plt.text(data6.index[-1:][0], data6['Temperature'][-1], sensor6label, fontsize=12, color=plt.rcParams['axes.color_cycle'][0])
			plt.legend(loc=0)
