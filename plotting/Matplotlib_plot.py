...
if (1):
	...
	try:
		if temp_plot:
			...
			plt.text(data0.index[-1:][0], data0['Temperature'][-1] - 0.5, data0['Temperature'][-1].value, fontsize=12)
			...
			plt.text(data1.index[-1:][0], data1['Temperature'][-1] - 0.5, sensor1label, fontsize=12)
			...
			plt.text(data2.index[-1:][0], data2['Temperature'][-1] - 0.5, sensor2label, fontsize=12)
			...
			plt.text(data3.index[-1:][0], data3['Temperature'][-1] - 0.5, sensor3label, fontsize=12)
			...
			plt.text(data4.index[-1:][0], data4['Temperature'][-1] - 0.5, sensor4label, fontsize=12)
			...
			plt.text(data5.index[-1:][0], data5['Temperature'][-1] - 0.5, sensor5label, fontsize=12)
			...
			plt.text(data6.index[-1:][0], data6['Temperature'][-1] - 0.5, sensor6label, fontsize=12)
			plt.legend(loc=0)
