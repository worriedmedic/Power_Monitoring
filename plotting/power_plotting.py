...
#plt.fill(data.last(td1).index, data['CTT'].last(td1).values, facecolor=plt.rcParams['axes.color_cycle'][0], alpha=0.35)
...
#plt.fill(data.last(td2).index, data['CTT'].last(td2).values, facecolor=plt.rcParams['axes.color_cycle'][1], alpha=0.35)
plt.legend(loc=2, ncol=2, fontsize=8).set_visible(True)
...
#plt.fill(data.last(td3).index, data['CTT'].last(td3).values, facecolor=plt.rcParams['axes.color_cycle'][2], alpha=0.35)
plt.legend(loc=2, ncol=2, fontsize=8).set_visible(True)
