...
if (1):
	...
	try:
		if temp_plot:
			...
			plt.plot_date(data4.last('16H').index, data4['Temperature'].last('16H').values, linestyle="dotted", linewidth=2, marker='None', color='0.2', label="Sensor 04")
			plt.legend(loc=0)
		...
		if press_plot:
			...
			plt.plot_date(data4.last('16H').index, data4['Pressure'].last('16H').values, linestyle="dotted", linewidth=2, marker='None', color='0.2', label="Sensor 04")
			plt.legend(loc=0)
		...
		if humid_plot:
			...
			plt.plot_date(data4.last('16H').index, data4['Humidity'].last('16H').values, linestyle="dotted", linewidth=2, marker='None', color='0.2', label="Sensor 04")
			plt.legend(loc=0)
