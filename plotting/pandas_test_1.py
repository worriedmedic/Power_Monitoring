...
if (1):
	...
	try:
		if temp_plot:
			...
			plt.plot_date(data4.last('16H').index, data4['Temperature'].last('16H').values, linestyle="solid", linewidth=2, marker='*', markersize=marker_size, color='0', label="Sensor 04")
			plt.legend(loc=0)
