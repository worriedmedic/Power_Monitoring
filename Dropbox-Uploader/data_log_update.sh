...
if [ -f '/home/pi/Power_Monitoring/dover.location' ]; then
  ...
  /home/pi/Power_Monitoring/Dropbox-Uploader/dropbox_uploader.sh -p upload /var/log/network_restart.log /Programming/dover/data_log/sys_log/
  /home/pi/Power_Monitoring/Dropbox-Uploader/dropbox_uploader.sh -p upload /var/log/fail2ban.log /Programming/dover/data_log/sys_log/
  ...
  /home/pi/Power_Monitoring/Dropbox-Uploader/dropbox_uploader.sh -p upload /var/log/network_restart.log /Programming/data_log/sys_log/
  /home/pi/Power_Monitoring/Dropbox-Uploader/dropbox_uploader.sh -p upload /var/log/fail2ban.log /Programming/dover/data_log/sys_log/
