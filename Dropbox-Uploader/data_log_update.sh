...
if [ -f '/home/pi/Power_Monitoring/dover.location' ]; then
  ...
  dropbox_uploader.sh -p upload ~/Power_Monitoring/logs/cuttyhunk/data_log/ /Programming/logs/cuttyhunk/
  dropbox_uploader.sh -p upload /var/log/network_restart.log /Programming/logs/cuttyhunk/data_log/sys_log/
  dropbox_uploader.sh -p upload /var/log/fail2ban.log /Programming/logs/cuttyhunk/data_log/sys_log/
  dropbox_uploader.sh -p upload ~/.ngrok2/_ngrok.log /Programming/logs/cuttyhunk/data_log/
  dropbox_uploader.sh -p upload ~/.vnc/raspberrypi\:1.log /Programming/logs/cuttyhunk/data_log/sys_log/
